...
object MovieRecommendationsALS {
  ...
  def main(args: Array[String]) {
    ...
    /**
      ...
      *
      * (Kicking and Screaming (1995),8.905848)
      * (I'll Do Anything (1994),8.523048)
      * (Alphaville (1965),8.214451)
      * (Fear of a Black Hat (1993),8.098396)
      * (To Live (Huozhe) (1994),7.986189)
      * (Bitter Moon (1992),7.925835)
      * (Incognito (1997),7.799504)
      * (Faithful (1996),7.3990636)
      * (Desperate Measures (1998),7.302633)
      * (Cronos (1992),7.3009496)
      */
  }
}
