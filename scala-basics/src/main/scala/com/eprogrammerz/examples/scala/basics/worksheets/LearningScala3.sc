  ...
  println(upperCase("yogen"))

  def transform(s: String, f: String => String): String = f(s)
  println(transform("yogen", s => s.toUpperCase()))
  println(transform("Yogen", s => s.toLowerCase()))
